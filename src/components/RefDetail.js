	...
	render() {
		return (
			<div className="ref-detail-wrapper">
				...
				{/* dev note: 
						using <span> results in commented output in innerHTML, which is auto-generated by React. This is new to v.15.
						I am unsure if using dangerouslySetInnerHTML is the best way to solve this issue. Because the string is known
						and validated before insertion, it seems to be secure but I am not fully aware of how that works so it could still
						be a vulnerability. 
				*/}
						<span 
